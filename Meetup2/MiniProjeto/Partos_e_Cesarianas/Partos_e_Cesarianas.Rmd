...
require(RCurl)
partos <-read.csv(text=getURL("https://raw.githubusercontent.com/agrou/RLadiesDocuments/master/Meetup2/MiniProjeto/Partos_e_Cesarianas/partos-e-cesarianas.csv"), header=T)
```
